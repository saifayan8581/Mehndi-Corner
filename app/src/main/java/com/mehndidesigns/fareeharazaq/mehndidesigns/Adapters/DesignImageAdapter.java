 ...
 */
public class DesignImageAdapter extends RecyclerView.Adapter<DesignImageAdapter.MyViewHolder>  {
    Activity mContext;
    LayoutInflater inflater;
    private ArrayList<DesignImageModel> items;

    public DesignImageAdapter(Activity mContext, ArrayList<DesignImageModel> items) {
    ...
    @Override
    public DesignImageAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = inflater.inflate(R.layout.design_image_card, parent, false);
