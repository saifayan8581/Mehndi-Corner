...
import com.mehndidesigns.fareeharazaq.mehndidesigns.Adapters.DoubleImageCardAdapter;
...
public class ImagesFragment extends Fragment {
    ...
    DoubleImageCardAdapter designImageAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        designImageAdapter= new DoubleImageCardAdapter(getActivity(),list);
